...
<p align="center">
  ...
  &nbsp;
  <img src="https://komarev.com/ghpvc/?username=Jufedev&style=flat-square&color=1e3a5f&label=visitors" />
</p>
...
### 🏗️ [AWS-Landing-Terraform](https://github.com/Jufedev/AWS-Landing-Terraform)

Multi-account AWS Landing Zone built with Terraform. Structured around reusable modules covering networking (VPC, Transit Gateway), compute (EC2, ASG, ALB), database (RDS, DocumentDB) and storage (S3, CloudFront). Includes GitHub Actions CI/CD pipeline with OIDC authentication — no long-lived credentials.

`HCL` `AWS` `Terraform` `GitHub Actions` `OIDC` `Landing Zone`
...
<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:0f3460,50:1e3a5f,100:0f172a&height=90&section=footer" />
</p>